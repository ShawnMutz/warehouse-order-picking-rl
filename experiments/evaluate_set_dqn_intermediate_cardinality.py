...
Purpose
-------
Determine how far the successful five-pick curriculum policy
...
RUN_NAME = "set_dqn_intermediate_cardinality_from_five_pick"
...
def create_agent(env):
    ...
    five-pick curriculum checkpoint.
...
def load_policy(
    ...
    """
    Load the successful frozen five-pick curriculum policy.
    """
...
def main():
    ...
    print(
        "\n"
        "================================================\n"
        "SET-DQN INTERMEDIATE-CARDINALITY EVALUATION\n"
        "================================================"
    )
    ...
    config = {
        ...
        "evaluation_type":
            "frozen_intermediate_cardinality",
