"""
Frozen cross-cardinality diagnostic from the successful fourteen-pick Set-DQN.

Purpose
-------
Evaluate how far the best fourteen-pick curriculum policy generalises to
...
Fresh deterministic evaluation sets are used so these 16-20-pick orders
have not been used in earlier curriculum-selection diagnostics.
"""
...
RUN_NAME = "set_dqn_cardinality_from_fourteen_pick_250"
...
def load_policy(
    ...
    print(
        "Frozen fourteen-pick policy loaded successfully."
    )
...
def evaluate_cardinality(
    ...
    print(
        "\n"
        "------------------------------------------------\n"
        f"EVALUATING FROZEN FOURTEEN-PICK POLICY: "
        f"{order_size} PICKS\n"
        "------------------------------------------------"
    )
...
def main():
    ...
    print(
        "\n"
        "================================================\n"
        "SET-DQN CARDINALITY DIAGNOSTIC FROM FOURTEEN-PICK POLICY\n"
        "================================================"
    )
    ...
    print(
        "\n"
        "================================================\n"
        "FOURTEEN-PICK CARDINALITY DIAGNOSTIC COMPLETE\n"
        "================================================"
    )
    ...
    print(
        "Frozen fourteen-pick scaling summary:"
    )
