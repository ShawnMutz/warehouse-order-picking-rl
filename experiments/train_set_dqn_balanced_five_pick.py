"""
Balanced five-pick Set-DQN experiment.

Purpose
-------
Test whether the permutation-invariant Set-DQN scales to unseen
five-pick combinations.

This is a direct development comparison with the earlier fixed-slot
coordinate-DQN five-pick experiment.

Earlier fixed-slot result:
    - 30 cycles
    - 2880 episodes
    - 50 unseen development combinations
    - 150 appearances per physical location
    - 0% development completion

This experiment keeps the same main training budget, reward shaping,
DQN hyperparameters and development probe set, while replacing the
fixed coordinate-slot representation with the permutation-invariant
Set-DQN.
...
Each cycle contains 96 five-pick orders.

Five compatible permutations of all 96 locations are aligned:
...
These reproduce the development probe design used in the earlier
fixed-slot five-pick experiment.

Exact development combinations are excluded from training, while
their constituent physical locations remain present in other
...
RUN_NAME = "set_dqn_balanced_five_pick_30_cycles"
...
def create_agent(env):
    """
    Create a fresh Set-DQN.

    No one-, two- or three-pick checkpoint is loaded.
    """
...
def save_experiment_config(
    ...
    config = {
        ...
        "comparison":
            (
                "set_dqn_vs_fixed_slot_"
                "five_pick_from_scratch"
            ),
    }
...
def main():
    ...
    print(
        "\n"
        "================================================\n"
        "SET-DQN BALANCED FIVE-PICK TRAINING\n"
        "================================================"
    )
    ...
    print(
        "\nEvaluating untrained five-pick Set-DQN..."
    )
    ...
    for schedule_row in training_schedule:
        ...
        if episode % evaluate_every == 0:
            ...
            print(
                f"SET-DQN FIVE-PICK DEVELOPMENT EVALUATION "
            ...
            if evaluation_is_better(
                ...
                print(
                    "New best five-pick Set-DQN model saved."
                )
    ...
    print(
        "\n"
        "================================================\n"
        "SET-DQN BALANCED FIVE-PICK TRAINING COMPLETE\n"
        "================================================"
    )
    ...
    if best_evaluation_summary is not None:
        ...
        print(
            "\nBest five-pick Set-DQN checkpoint:"
        )
