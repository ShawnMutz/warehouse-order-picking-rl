"""
Frozen cross-cardinality diagnostic from the successful ten-pick Set-DQN.

Purpose
-------
Evaluate how far the best ten-pick curriculum policy generalises to
...
Best checkpoint from:
    ...
    set_dqn_curriculum_ten_pick_from_seven_15_cycles
...
RUN_NAME = "set_dqn_cardinality_from_ten_pick"
...
def load_policy(
    ...
    print(
        "\nLoading frozen ten-pick Set-DQN:"
    )
    ...
    print(
        "Frozen ten-pick policy loaded successfully."
    )
...
def evaluate_cardinality(
    ...
    print(
        "\n"
        "------------------------------------------------\n"
        f"EVALUATING FROZEN TEN-PICK POLICY: "
        f"{order_size} PICKS\n"
        "------------------------------------------------"
    )
...
def main():
    ...
    print(
        "\n"
        "================================================\n"
        "SET-DQN CARDINALITY DIAGNOSTIC FROM TEN-PICK POLICY\n"
        "================================================"
    )
    ...
    print(
        f"\nRun name:               {RUN_NAME}\n"
        f"Model:                  ten-pick curriculum best\n"
        f"Policy frozen:          yes\n"
    ...
    print(
        "\n"
        "================================================\n"
        "TEN-PICK CARDINALITY DIAGNOSTIC COMPLETE\n"
        "================================================"
    )
    ...
    print(
        "Frozen ten-pick scaling summary:"
    )
