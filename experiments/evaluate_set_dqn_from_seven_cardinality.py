"""
Intermediate-cardinality evaluation of the frozen five-pick Set-DQN.

Purpose
-------
Determine how far the successful seven-pick curriculum policy
generalises beyond five picks before another curriculum stage is
introduced.
...
This is a diagnostic experiment used to select the next curriculum
target. Exact optimisation is deliberately omitted because the main
...
The source policy achieved 100% completion on the existing five-pick
development set.

Interpretation
--------------
The highest intermediate cardinality retaining useful zero-shot
performance will guide the next curriculum-training experiment.
"""
...
RUN_NAME = "set_dqn_cardinality_from_seven_pick"
...
SOURCE_MODEL_PATH = (
    ...
    / "results"
    / "development"
    / "set_dqn_curriculum_seven_pick_from_five_15_cycles"
    / "set_dqn_best_model.pt"
)


# ============================================================
# DETERMINISTIC ORDER SEEDS
# ============================================================

# Separate deterministic ranges are used so that each
# cardinality has a distinct evaluation set.
...
def create_agent(env):
    """
    Create Set-DQN with the same architecture as the trained
    seven-pick curriculum checkpoint.
...
def extract_policy_state_dict(checkpoint):
    ...
    # Checkpoint itself may be a PyTorch state_dict.
    if (
        values
        and all(
...
def load_policy(
    ...
    """
    Load the successful frozen seven-pick curriculum policy.
    """
...
def evaluate_order(
    ...
    """
    Greedily evaluate the frozen policy on one order.
    """
...
def evaluate_cardinality(
    ...
    """
    Evaluate all orders of one intermediate cardinality.
    """
...
def main():
    ...
    print(
        "\n"
        "================================================\n"
        "SET-DQN CARDINALITY DIAGNOSTIC FROM SEVEN-PICK POLICY\n"
        "================================================"
    )
    ...
    print(
        f"\nRun name:               {RUN_NAME}\n"
        f"Model:                  seven-pick curriculum best \n"
        f"Policy frozen:          yes\n"
    ...
    summary_path = (
        results_directory
        / "intermediate_cardinality_summary.csv"
    )

    raw_path = (
        results_directory
        / "intermediate_cardinality_raw.csv"
    )
    ...
    config = {
        ...
        "evaluation_type":
            "frozen_cardinality_from_seven_pick",
    ...
    print(
        "\n"
        "================================================\n"
        "INTERMEDIATE-CARDINALITY EVALUATION COMPLETE\n"
        "================================================"
    )
    ...
    print(
        "Frozen-policy intermediate scaling summary:"
    )
